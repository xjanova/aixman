...
>
> **ใช้งานอยู่ 7 คลิป** — `hero-reel`, `dancer`, `city`, `creature`, `anime`,
> `portrait`, `product` (Kling 2.5, 720p, 5 วิ) โหลดมาบีบแล้ววางใน
> `public/showcase/` เรียบร้อย
>
> **hero เจนรอบสองโดยใส่ start frame แล้ว** — รอบแรกเจนจาก prompt ล้วน ได้โทน
> ส้มอำพันที่ชนกับทั้งเว็บ รอบสองส่ง `hero-reel.jpg` เป็น `keyframes.start`
> เฟรมแรกของคลิปเลยเป็นภาพเดียวกับ poster เป๊ะ crossfade ไม่กระโดด
> และยังได้ใช้ poster 2K (3024×1296) ที่คมกว่าคลิป 720p
> **ราคาจริง: Kling 2.5 ที่ 21:9 720p 5 วิ = 140 เครดิต** (ไม่ใช่ 3,500 —
> อันนั้นคือ Seedance 2.0 Pro ที่ 1080p) ถูกพอที่จะไม่ต้องไปดิ้นทำ automation
>
