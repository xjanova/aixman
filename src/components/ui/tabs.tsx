...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center gap-1 p-1.5 rounded-xl neu-inset-sm bg-surface/60",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:text-white data-[state=active]:neu-raised-sm",
      "data-[state=active]:shadow-[0_4px_12px_rgba(59,130,246,0.25)]",
