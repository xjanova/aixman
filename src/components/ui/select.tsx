...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "bg-surface-light/80 neu-inset-sm border border-border/50",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-[300px] min-w-[8rem] overflow-hidden rounded-xl",
        "glass-neu border border-border/30",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "hover:bg-surface-light/60 focus:bg-surface-light/60",
      "data-[state=checked]:bg-primary/10 data-[state=checked]:text-primary-light",
